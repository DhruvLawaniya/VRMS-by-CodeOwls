...
snake=Button(BFrame_left,text="Snake",command=snake)
...
quote = Label(root,text = b['text'])
author = Label(root,text = '-'+b['author'])
quote.grid(row = 2, column = 7)
author.grid(row = 3, column = 8)
